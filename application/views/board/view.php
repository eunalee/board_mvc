...
<div class="container">
	...
	<?php if(isset($_SESSION['memberSeq']) && in_array($_SESSION['memberSeq'], array(1, $data['boardList']['nMemberSeq']))) : ?>
	<a href="/board_mvc/board/writeListForm?listSeq=<?php echo $data['boardList']['nListSeq']; ?>&mode=update" class="btn btn-primary">수정</a>
	<a href="#" id="boardListDeleteBtn" class="btn btn-primary">삭제</a>
	<?php endif; ?>
	...
	<div class="list-group">
		...
		<div id="comment_<?php echo $comment['nCommentSeq']; ?>" class="list-group-item list-group-item-action">
			<div class="d-flex w-100 justify-content-between">
				<span><?php echo $comment['sId']; ?> | <?php echo date('Y.m.d. H:i:s', strtotime($comment['dtCreateDate'])); ?></span>
				<small>
					<a href="#" id="replyFormCreate" class="text-reset text-decoration-none" commentSeq="<?php echo $comment['nCommentSeq']; ?>">댓글</a>
					<?php if(isset($_SESSION['memberSeq']) && $_SESSION['memberSeq'] > 0 && $_SESSION['memberSeq'] == $comment['nMemberSeq']) : ?>
					 | <a href="#" id="commentUpdate" class="text-reset text-decoration-none" commentSeq="<?php echo $comment['nCommentSeq']; ?>">수정</a>
					 | <a href="#" id="commentDelete" class="text-reset text-decoration-none" commentSeq="<?php echo $comment['nCommentSeq']; ?>">삭제</a>
					<?php endif; ?>
				</small>
			</div>
